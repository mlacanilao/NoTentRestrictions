...
internal static class NoTentRestrictionsConfig
{
    ...
    internal static ConfigEntry<bool> EnableMaxFertility = null!;
    internal static ConfigEntry<bool> EnableNoSoilUpgradeLimit = null!;
    internal static ConfigEntry<bool> EnableMaxElectricity = null!;
    internal static ConfigEntry<bool> EnableTeleporter = null!;
    internal static ConfigEntry<bool> EnableDiningSpotSign = null!;
    ...
    internal static void LoadConfig(ConfigFile config)
    {
        ...
        EnableNoSoilUpgradeLimit = config.Bind(
            ...
            defaultValue: false,
            description:
            "Enable or disable removing the soil upgrade limit inside tents.\n" +
            "Set to 'true' to remove the soil upgrade limit, or 'false' to keep the default.\n" +
            "テント内での土壌アップグレード制限の解除を有効または無効にします。\n" +
